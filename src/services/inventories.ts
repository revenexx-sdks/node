...
export class Inventories {
    ...
    inventoriesAdjust(
        ...
        if (typeof reason === 'undefined') {
            throw new RevenexxAPIRevenexxException('Missing required parameter: "reason"');
        }
    ...
    inventoriesCommit(
        ...
        if (typeof orderRef === 'undefined') {
            throw new RevenexxAPIRevenexxException('Missing required parameter: "orderRef"');
        }
    ...
    inventoriesStockCreate(
        ...
        if (typeof locationId === 'undefined') {
            throw new RevenexxAPIRevenexxException('Missing required parameter: "locationId"');
        }
