...
export class Tokens {
    ...
    tokensList(
        ...
        if (typeof bucketId === 'undefined') {
            throw new RevenexxAPIRevenexxException('Missing required parameter: "bucketId"');
        }
        if (typeof fileId === 'undefined') {
            throw new RevenexxAPIRevenexxException('Missing required parameter: "fileId"');
        }
    ...
    tokensDelete(
        ...
        if (typeof tokenId === 'undefined') {
            throw new RevenexxAPIRevenexxException('Missing required parameter: "tokenId"');
        }
