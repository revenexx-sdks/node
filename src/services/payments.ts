...
export class Payments {
    ...
    paymentsCreate(
        ...
        if (typeof amount === 'undefined') {
            throw new RevenexxAPIRevenexxException('Missing required parameter: "amount"');
        }
        if (typeof methodCode === 'undefined') {
            throw new RevenexxAPIRevenexxException('Missing required parameter: "methodCode"');
        }
    ...
    paymentsProvidersCreate(
        ...
        if (typeof provider === 'undefined') {
            throw new RevenexxAPIRevenexxException('Missing required parameter: "provider"');
        }
