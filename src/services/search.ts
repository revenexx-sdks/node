...
export class Search {
    ...
    searchSearchDocumentsGet(
        ...
        if (typeof collection === 'undefined') {
            throw new RevenexxAPIRevenexxException('Missing required parameter: "collection"');
        }
    ...
    searchGetDocument(
        ...
        if (typeof documentId === 'undefined') {
            throw new RevenexxAPIRevenexxException('Missing required parameter: "documentId"');
        }
    ...
    searchMultiSearch(
        ...
        if (typeof searches === 'undefined') {
            throw new RevenexxAPIRevenexxException('Missing required parameter: "searches"');
        }
