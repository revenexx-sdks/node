...
export class Orderlists {
    ...
    orderlistsCreate(
        ...
        if (typeof ownerId === 'undefined') {
            throw new RevenexxAPIRevenexxException('Missing required parameter: "ownerId"');
        }
        if (typeof ownerName === 'undefined') {
            throw new RevenexxAPIRevenexxException('Missing required parameter: "ownerName"');
        }
    ...
    orderlistsItemsList(
        ...
        if (typeof listId === 'undefined') {
            throw new RevenexxAPIRevenexxException('Missing required parameter: "listId"');
        }
