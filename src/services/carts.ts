...
export class Carts {
    ...
    cartsClaim(
        ...
        if (typeof contactId === 'undefined') {
            throw new RevenexxAPIRevenexxException('Missing required parameter: "contactId"');
        }
        if (typeof sessionKey === 'undefined') {
            throw new RevenexxAPIRevenexxException('Missing required parameter: "sessionKey"');
        }
    ...
    cartsIoProfilesCreate(
        ...
        if (typeof direction === 'undefined') {
            throw new RevenexxAPIRevenexxException('Missing required parameter: "direction"');
        }
        if (typeof name === 'undefined') {
    ...
    cartsMerge(
        ...
        if (typeof sourceCartId === 'undefined') {
            throw new RevenexxAPIRevenexxException('Missing required parameter: "sourceCartId"');
        }
        if (typeof targetCartId === 'undefined') {
            throw new RevenexxAPIRevenexxException('Missing required parameter: "targetCartId"');
        }
    ...
    cartsItemsList(
        ...
        if (typeof cartId === 'undefined') {
            throw new RevenexxAPIRevenexxException('Missing required parameter: "cartId"');
        }
    ...
    cartsItemsReplace(
        ...
        if (typeof items === 'undefined') {
            throw new RevenexxAPIRevenexxException('Missing required parameter: "items"');
        }
