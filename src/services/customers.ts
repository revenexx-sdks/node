...
export class Customers {
    ...
    customersAddressesCreate(
        ...
        if (typeof city === 'undefined') {
            throw new RevenexxAPIRevenexxException('Missing required parameter: "city"');
        }
        if (typeof country === 'undefined') {
            throw new RevenexxAPIRevenexxException('Missing required parameter: "country"');
        }
        if (typeof street === 'undefined') {
            throw new RevenexxAPIRevenexxException('Missing required parameter: "street"');
        }
        if (typeof zip === 'undefined') {
            throw new RevenexxAPIRevenexxException('Missing required parameter: "zip"');
        }
    ...
    customersAuthLogin(
        ...
        if (typeof email === 'undefined') {
            throw new RevenexxAPIRevenexxException('Missing required parameter: "email"');
        }
        if (typeof password === 'undefined') {
            throw new RevenexxAPIRevenexxException('Missing required parameter: "password"');
        }
    ...
    customersAuthLogout(
        ...
        if (typeof sessionId === 'undefined') {
            throw new RevenexxAPIRevenexxException('Missing required parameter: "sessionId"');
        }
        if (typeof userId === 'undefined') {
            throw new RevenexxAPIRevenexxException('Missing required parameter: "userId"');
        }
    ...
    customersAuthRecoveryConfirm(
        ...
        if (typeof secret === 'undefined') {
            throw new RevenexxAPIRevenexxException('Missing required parameter: "secret"');
        }
        if (typeof userId === 'undefined') {
            throw new RevenexxAPIRevenexxException('Missing required parameter: "userId"');
        }
