...
export class Orders {
    ...
    ordersItemsCancel(
        ...
        if (typeof positions === 'undefined') {
            throw new RevenexxAPIRevenexxException('Missing required parameter: "positions"');
        }
    ...
    ordersPaymentStatusUpdate(
        ...
        if (typeof status === 'undefined') {
            throw new RevenexxAPIRevenexxException('Missing required parameter: "status"');
        }
    ...
    ordersReturnsComplete(
        ...
        if (typeof rid === 'undefined') {
            throw new RevenexxAPIRevenexxException('Missing required parameter: "rid"');
        }
    ...
    ordersReturnsReceive(
        ...
        if (typeof data === 'undefined') {
            throw new RevenexxAPIRevenexxException('Missing required parameter: "data"');
        }
